...
const Section = ({
  ...
  const renderGradientBalls = (isRight) => {
    ...
    return (
      ...
      >
        <defs>
          {/* Updated gradients to use UAE color palette */}
          <linearGradient id="gradient-0" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#1A237E" /> {/* Deep Royal Blue */}
            <stop offset="100%" stopColor="rgba(10, 17, 40, 0)" /> {/* Transparent Deep Navy */}
          </linearGradient>
          <linearGradient id="gradient-1" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#E8C591" /> {/* Elegant Gold */}
            <stop offset="100%" stopColor="rgba(10, 17, 40, 0)" /> {/* Transparent Deep Navy */}
          </linearGradient>
          <linearGradient id="gradient-2" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#F5F5F5" /> {/* Off-white */}
            <stop offset="100%" stopColor="rgba(10, 17, 40, 0)" /> {/* Transparent Deep Navy */}
          </linearGradient>
        </defs>
