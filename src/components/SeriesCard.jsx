      ...
      >
        {items.map((item, idx) => (
          <motion.li
            ...
            className="relative w-[280px] max-w-full shrink-0 rounded-xl sm:rounded-2xl border border-b-0 border-[#1A237E]/20 bg-gradient-to-br from-[#1A237E]/90 to-[#0A1128]/70 backdrop-blur-sm sm:w-[350px] md:w-[450px] shadow-2xl overflow-hidden"
            key={item.title}
          ...
          >
            <div className="flex flex-row items-center">
              <div className="w-2/3 p-2 sm:p-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#F5F5F5]/90 mb-1 sm:mb-2">
                  {item.name}
                </h3>
                <div className="relative z-20 mt-2 sm:mt-4 flex flex-row items-center">
                  <span className="flex flex-col gap-1">
                    {/* Updated text color to Off-white */}
                    <span className="text-xs sm:text-sm leading-[1.6] font-medium text-[#E8C591]/80">
                      {item.title}
                    </span>
                    {/* Updated role text color to Elegant Gold */}
                    <span className="text-xs sm:text-sm leading-[1.6] font-normal text-[#E8C591]/80 italic">
                      {item.role}
                    </span>
                  </span>
                </div>
